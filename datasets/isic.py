...
class ISIC(SlimDataLoaderBase):
    """
    DataLoader for ISIC dataset.

    Note: It returns shape (B, C, H, W...) where B is the batch size and C is the number of channels.
    """
    ...
    def __init__(
        ...
        """
        Constructor for ISIC DataLoader.
